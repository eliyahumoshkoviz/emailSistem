// const { createUser, getAll, getOne, updateFilde, delUser } = require("../BL/services/user.service");
...
// //   let res = await getAll({ _id: "65fc062a8570f185fea1744b" });
// //   let res = await updateFilde({ _id: "65fc062a8570f185fea1744b" }, {fullName: "x"});
//   let res = await delUser({ _id: "65fc062a8570f185fea1744b" });
